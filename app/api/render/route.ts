...
export async function POST (req: NextRequest) {
  try {
    ...
    await page.addScriptTag({ url: 'https://unpkg.com/three@0.178.0/build/three.min.js' })
    await page.addScriptTag({ url: 'https://unpkg.com/three@0.178.0/examples/js/loaders/GLTFLoader.js' })
