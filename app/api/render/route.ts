    ...
    const glContext = gl(width, height, { preserveDrawingBuffer: true }) as any
        ...
        const downgrade = (src: string) => {
          ...
          return trimmed
            ...
            .replace(/isampler2DShadow/g, 'sampler2D')
            .replace(/usampler2DShadow/g, 'sampler2D')
            .replace(/isampler2D/g, 'sampler2D')
            .replace(/usampler2D/g, 'sampler2D')
            .replace(/isamplerCubeShadow/g, 'samplerCube')
            .replace(/usamplerCubeShadow/g, 'samplerCube')
