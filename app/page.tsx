    ...
    >
      ...
      <section className="mx-auto max-w-7xl grid md:grid-cols-2 gap-12 px-6 py-24 items-center">
        ...
        <div className="space-y-6 order-2 md:order-1">
          ...
          >
            Gift a card that
            <br className="hidden md:block" /> transforms{" "}
            <span style={{ color: orange }}>photos</span>
            <br className="hidden md:block" /> into frame-worthy art
          </h1>
          <p className="text-lg max-w-md" style={{ color: brown }}>
            Make a card as unique as they are—one they’ll want to frame, not throw
            away.
          </p>
          <Link
            href="/templates"
        ...
        <div className="order-1 md:order-2">
          <Image
            src="/images/hero-cartoon-holder.png"
      ...
      <section className="mx-auto max-w-3xl px-6 pb-24 text-center">
        ...
        <p className="text-xl italic" style={{ color: brown }}>
          “A really unique and personal way to surprise your loved ones! My friend
          literally called me crying laughing when she got the cat card.”
        </p>
        <span className="mt-4 block font-semibold" style={{ color: teal }}>
          — Jess P.
        </span>
      </section>
