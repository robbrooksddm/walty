...
useEffect(() => {
  ...
  const bridge = (e: PointerEvent) => {
    ...
    if (corner === 'rot' && fc.getActiveObject()) {
      ...
      const mirroredX = 2 * centerX - (e.clientX - rect.left)
      const mirroredY = 2 * centerY - (e.clientY - rect.top)
      dx = rect.left + mirroredX - e.clientX
      dy = rect.top  + mirroredY - e.clientY
    }
