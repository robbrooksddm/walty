...
const syncSel = () => {
  ...
  if (croppingRef.current && tool?.isActive && tool.img && tool.frame) {
    selEl.classList.add('crop')
    cropEl && cropEl.classList.add('crop')
    selEl.style.zIndex = '51'
    if (cropEl) cropEl.style.zIndex = '50'
  ...
  selEl.classList.remove('crop')
  selEl.style.zIndex = '40'
  cropEl && (cropEl.classList.remove('crop'), cropEl.style.zIndex = '40')
